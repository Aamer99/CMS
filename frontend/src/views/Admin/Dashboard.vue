<template>
    <div class="grid grid-flow-row gap-2 h-screen" style="padding: 10px">
        <div>
            <div
                ...
                <div class="grid grid-flow-col w-full">
                    <div class="col-span-11">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"> New Employee</h5>
                    </div>
        ...
        <div>
            <div
                class="max-w-sm p-6 bg-white h-full border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
            >
                <h5
